...
entity vadd_vadd_mat_in_ram is 
   generic(
  -- Common module parameters
       MEMORY_SIZE        : integer := 320000;
...
architecture rtl of vadd_vadd_mat_in_ram is 
...
architecture arch of vadd_vadd_mat_in is
    component vadd_vadd_mat_in_ram is
        port (
            clka : IN STD_LOGIC;
            rsta : IN STD_LOGIC;
...
begin
    vadd_vadd_mat_in_ram_U :  component vadd_vadd_mat_in_ram
    port map (
        clka => clk,
        rsta => reset,
        addra => address0,
