...
CLFLAGS:= --xp "param:compiler.preserveHlsOutput=1" --xp "param:compiler.generateExtraRunData=true" --xp "vivado_param:physynth.ultraRAMOptOutput=false" --xp "vivado_prop:run.__KERNEL__.{STEPS.SYNTH_DESIGN.ARGS.MAX_URAM_CASCADE_HEIGHT}={1}" --xp "vivado_param:synth.elaboration.rodinMoreOptions={rt::set_parameter disableOregPackingUram true}" -s
